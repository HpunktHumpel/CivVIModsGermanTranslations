...
1. Better Balanced Game (github.com/CivilizationVIBetterBalancedGame | onyxum)
...
1. RomanHoliday's AI Behaviour Rework v3.283 (RomanHoliday | onyxum)
...
1. Yet (not) Another Maps Pack (Gedemon | onyxum)
