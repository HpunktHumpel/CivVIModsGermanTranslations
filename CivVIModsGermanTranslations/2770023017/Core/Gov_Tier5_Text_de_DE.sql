...
VALUES	('de_DE',	'LOC_GOVERNMENT_JNR_ABSOLUTISM_NAME',					'Absolute Monarchie|Absolute Monarchie|Absoluten Monarchie|Absoluten Monarchie|Absolute Monarchie',													'feminine',	0			),
		('de_DE',	'LOC_GOVERNMENT_JNR_COMMONWEALTH_NAME',					'Noble Nationengemeinschaft|Noble Nationengemeinschaft|Noblen Nationengemeinschaft|Noblen Nationengemeinschaft|Noble Nationengemeinschaft',			'feminine',	0			),
		('de_DE',	'LOC_GOVERNMENT_JNR_REVOLUTIONARY_NAME',				'Revolutionäre Republik|Revolutionäre Republik|Revolutionären Republik|Revolutionären Republik|Revolutionäre Republik',								'feminine',	0			),
...
VALUES	('de_DE',	'LOC_GOVT_INHERENT_BONUS_JNR_ABSOLUTISM',				'Erhaltet eine Kopie jeder Eurer verbesserten Luxusressourcen. Strategische Ressourcen sammeln doppelt so viel in Städten mit etablierten Gouverneur.'),
		('de_DE',	'LOC_GOVT_INHERENT_BONUS_JNR_COMMONWEALTH',				'Eure [ICON_TradeRoute] Handelswege zur Stadt eines Verbündeten oder Suzeräns bieten +2 [ICON_Food] Nahrung, +2 [ICON_Production] Produktion, +2 [ICON_Gold] Gold und +2 [ICON_Faith] Glauben für beide Städte.'),
