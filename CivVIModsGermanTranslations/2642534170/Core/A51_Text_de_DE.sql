...
VALUES
  ('LOC_BUILDING_JNR_AREA_51_NAME',											'de_DE',	'Area 51|Area 51|Area 51|Area 51|Area 51', 'feminine', '1'),
	('LOC_UNIT_JNR_51_UFO_NAME',													'de_DE',	'UFO|UFO|UFO|UFOs|UFO', 'neuter', '1'),
	('LOC_UNIT_JNR_51_ALIEN_NAME',												'de_DE',	'Alien-Infiltrator|Alien-Infiltrator|Alien-Infiltrator|Alien-Infiltrators|Alien-Infiltrator', 'masculine', '1'),
	('LOC_PROMOTION_JNR_51_UFO_HIVEMIND_NAME',						'de_DE',	'Schwarmbewusstsein|Schwarmbewusstsein|Schwarmbewusstsein|Schwarmbewusstseins|Schwarmbewusstsein', 'neuter', '1'),
	('LOC_PROMOTION_JNR_51_UFO_MIND_CONTROL_NAME',				'de_DE',	'Bewusstseinskontrolle|Bewusstseinskontrolle|Bewusstseinskontrolle|Bewusstseinskontrolle|Bewusstseinskontrolle', 'feminine', '1'),
	('LOC_PROMOTION_JNR_51_UFO_SHIELDING_NAME',						'de_DE',	'Unobtanium-Rüstung|Unobtanium-Rüstung|Unobtanium-Rüstung|Unobtanium-Rüstung|Unobtanium-Rüstung', 'feminine', '1'),
	('LOC_PROMOTION_JNR_51_UFO_SHIELDING_WEAK_SPOT_NAME',	'de_DE',	'Schwachstelle|Schwachstelle|Schwachstelle|Schwachstelle|Schwachstelle', 'feminine', '1'),
	('LOC_PROMOTION_JNR_51_UFO_XENO_CAMOUFLAGE_NAME',			'de_DE',	'Tarnimplantate|Tarnimplantate|Tarnimplantaten|Tarnimplantate|Tarnimplantate', 'neuter', '2'),
	('LOC_PROMOTION_JNR_51_UFO_CLONING_VATS_NAME',				'de_DE',	'Klon-Behälter|Klon-Behälter|Klon-Behälter|Klon-Behälters|Klon-Behälter', 'masculine', '1');
