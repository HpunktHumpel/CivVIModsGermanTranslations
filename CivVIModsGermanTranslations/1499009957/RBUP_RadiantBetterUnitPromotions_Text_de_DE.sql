...
--                      LANGUAGE : GERMAN										
INSERT OR REPLACE INTO LocalizedText 	(Tag, 																	Language, 			Text)
VALUES									("LOC_WEAKSPOTS_VS_ANTICAVALRY_MODIFIER_DESCRIPTION",					'de_DE', 			"Anti-Kavallerie-Einheiten sind anfälliger für Fernkampfangriffe."),
										("LOC_WEAKSPOTS_VS_WOUNDED_MODIFIER_DESCRIPTION",						'de_DE', 			"Verwundete Soldaten konzentrieren sich weniger auf das Ausweichen von Fernkampfangriffen."),
										...
										("LOC_ABILITY_HEAVYCAVALRY_BONUS_VS_FORTIFIED_MODIFIER_DESCRIPTION",	'de_DE', 			"Verschanzte Einheiten sind anfälliger gegenüber Angriffen der schweren Kavallerie."),
										("LOC_ABILITY_LIGHTCAVALRY_BONUS_VS_SIEGE_MODIFIER_DESCRIPTION",		'de_DE', 			"Belagerungseinheiten sind eher verwundbar gegen leichte Kavallerieangriffe."),
										("LOC_RBUP_ABILITY_SIEGE_VS_NAVAL_MODIFIER_DESCRIPTION",				'de_DE', 			"Seestreitkräfte sind verwundbar gegen Fernkampfangriffe von Belagerungseinheiten."),
										("LOC_RBUP_ABILITY_SIEGE_VS_UNITINDISTRICT_MODIFIER_DESCRIPTION",		'de_DE', 			"Einheiten in Bezirken sind indirekt verwundbar gegen Fernkampfangriffe von Belagerungseinheiten."),
										("LOC_RBUP_ABILITY_WARRIORMONK_DESCRIPTION",							'de_DE', 			"Kriegsmönche wissen, wie sie die Schwächen verwundeter Feinde ausnutzen können. (Stufe 1)"),
										("LOC_RBUP_ABILITY_ANTITANK_DESCRIPTION",								'de_DE', 			"Schwere Kavallerieeinheiten sind verwundbar gegenüber Hubschraubern."),
										("LOC_NAVAL_MELEE_IN_FORMATION_MODIFIER_DESCRIPTION",					'de_DE', 			"Diese Einheit ist stärker in einer Formation."),
										("LOC_NAVAL_MELEE_VSNAVALRAIDER_MODIFIER_DESCRIPTION",					'de_DE', 			"Seeräubereinheiten sind verwundbar gegen Nahkampfeinheiten der Marine."),
										("LOC_NAVAL_RANGED_SEATILESBONUS_MODIFIER_DESCRIPTION",					'de_DE', 			"Seefernkampfeinheiten kämpfen besser auf Ozeanfeldern."),
										("LOC_AIR_FIGHTER_VSAIRBOMBER_MODIFIER_DESCRIPTION",					'de_DE', 			"Bomberflugzeuge sind verwundbar gegen Jagdflugzeuge."),
										("LOC_AIR_BOMBER_VSNAVALUNITS_MODIFIER_DESCRIPTION",					'de_DE', 			"Seestreitkräfte sind verwundbar gegen Bomberflugzeuge."),
										("LOC_RBUP_ABILITY_NAVAL_MELEE_DESCRIPTION",							'de_DE', 			"+3 [ICON_Strength] Kampfstärkebonus in einer Formation und +5 [ICON_Strength] gegen Marine-Seeräuber."),
...
VALUES									("LOC_PROMOTION_RBUP_WARCRY_NAME",										'de_DE', 			"Schlachtruf"),
										...
										("LOC_PROMOTION_RBUP_FIRST_AID_KIT_DESCRIPTION",						'de_DE', 			"+10 LP pro Runde beim Heilen in allen Gebieten."),
...
VALUES									("LOC_PROMOTION_RBUP_ARROW_STORM_NAME",									'de_DE', 			"Dauerbeschuss"),
										...
										("LOC_PROMOTION_RBUP_SHARPSHOOTERS_DESCRIPTION",						'de_DE', 			"+1 [ICON_Range] Range when on hills."),
...
VALUES									("LOC_PROMOTION_RBUP_DEADLY_WALLS_NAME",								'de_DE', 			"Tödliche Mauern"),
										...
										("LOC_PROMOTION_RBUP_ART_OF_PIERCING_DESCRIPTION",						'de_DE', 			"+5 [ICON_Strength] Combat Strength in all situations."),
...
VALUES									("LOC_PROMOTION_RBUP_FRIGHTENING_ARSENAL_NAME",							'de_DE', 			"Furchteinflößende Ausrüstung"),
										...
										("LOC_PROMOTION_RBUP_BREAKTHROUGH_DESCRIPTION",							'de_DE', 			"+1 zusätzlicher Angriffe pro Runde falls [ICON_Movement] Fortbewegung es erlaubt.[NEWLINE]Kann sich nach dem Angriff bewegen."),
...
VALUES									("LOC_PROMOTION_RBUP_RANGER_NAME",										'de_DE', 			"Förster"),
										...
										("LOC_PROMOTION_RBUP_EVASION_MANEUVERS_DESCRIPTION",					'de_DE', 			"+5 [ICON_Strength] Kam bei Verteidigung.[NEWLINE]Kann sich nach Angriff bewegen."),
...
VALUES									("LOC_PROMOTION_MONK_SHADOW_STRIKE_NAME",								'de_DE', 			"Chakra Meister"),
										...
										("LOC_PROMOTION_MONK_SHADOW_STRIKE_DESCRIPTION",						'de_DE', 			"Doppelter Flankierungsbonus.[NEWLINE]+6 LPs pro Runde während der Heilung auf jedem Gelände."),
										("LOC_PROMOTION_MONK_TWILIGHT_VEIL_DESCRIPTION",						'de_DE', 			"Nur angrenzende Einheiten können diese Einheit entdecken.[NEWLINE]+6 LPs pro Runde während der Heilung auf jedem Gelände."),
...
VALUES									("LOC_PROMOTION_RBUP_ARMORED_HULL_NAME",								'de_DE', 			"Gepanzerter Schiffsrumpf"),
										...
										("LOC_PROMOTION_RBUP_EXPERT_SEAENGINEERA_DESCRIPTION",					'de_DE', 			"Kann jetzt im neutralen Gebiet 12 LP pro Runde heilen."),
										...
										("LOC_PROMOTION_RBUP_REPAIRING_EXPERT_DESCRIPTION",						'de_DE', 			"Kann sich nach Angriffen heilen.[NEWLINE]Kann nun im Feindgebiet für 6 LP pro Runde heilen."),
...
VALUES									("LOC_PROMOTION_RBUP_LARGECALIBER_WEAPONS_NAME",						'de_DE', 			"Großkaliberwaffen"),
										...
										("LOC_PROMOTION_RBUP_EXPERT_SEAENGINEERB_DESCRIPTION",					'de_DE', 			"Kann jetzt im neutralen Gebiet für 8 LP pro Runde heilen."),
...
VALUES									("LOC_PROMOTION_RBUP_PLUNDERER_NAME",									'de_DE', 			"Plünderer"),
										...
										("LOC_PROMOTION_RBUP_EXPERT_SEAENGINEERC_DESCRIPTION",					'de_DE', 			"Kann jetzt im neutralen Gebiet für 6 Hps pro Runde heilen."),
...
VALUES									("LOC_PROMOTION_RBUP_ADVANCED_LOGISTIC_NAME",							'de_DE', 			"Fortgeschrittene Decklogistik"),
										...
										("LOC_PROMOTION_RBUP_REPAIRING_EXPERTCREW_DESCRIPTION",					'de_DE', 			"Kann jetzt im neutralen Gebiet für 6 Hps pro Runde heilen.[NEWLINE]+1 zusätzliche Flugzeugkapazität."),
...
VALUES									("LOC_PROMOTION_RBUP_IMPROVED_AIMINGSYSTEM_NAME",						'de_DE', 			"Flinke Ausweichmanöver"),
										...
										("LOC_PROMOTION_RBUP_IMPROVED_AIMINGSYSTEM_DESCRIPTION",				'de_DE', 			"+7 [ICON_Strength] Kampfstärke gegen Jagdflugzeuge."),
										...
										("RBUP_IMPROVED_AIMINGSYSTEM_VSFIGHTERCLASS_DESC",						'de_DE', 			"Dieses Jagdflugzeug verfügt über ein verbessertes Zielsystem, das es ermöglicht, andere Jagdflugzeuge zu überwältigen."),
...
VALUES									("LOC_PROMOTION_RBUP_CLUSTER_BOMBS_NAME",								'de_DE', 			"Streubomben"),
										...
										("LOC_PROMOTION_RBUP_STEALTH_MATERIALS_DESCRIPTION",					'de_DE', 			"+5 [ICON_Strength] Kampfstärke gegen Jagdflugzeuge."),
