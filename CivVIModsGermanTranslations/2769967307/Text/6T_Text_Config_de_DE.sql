...
UPDATE LocalizedText SET Text = REPLACE(Text, 'Erstellt Flotten und Armadas aus Marineeinheiten durch Merkantilismus statt Nationalismus und Mobilisierung.',						'Erstellt [ICON_Corps] Flotten durch die Ausrichtung Kaufmannsgilde und [ICON_Army] Armadas durch Merkantilismus.')							WHERE Tag='LOC_TRAIT_CIVILIZATION_TREASURE_FLEET_EXPANSION2_DESCRIPTION' 	AND Language ='de_DE';
UPDATE LocalizedText SET Text = REPLACE(Text, 'Kann Korps (Söldner-Ausrichtung) und Armeen (Nationalismus-Ausrichtung) früher formen.',												'Kann [ICON_Corps] Korps durch Öffentliche Verwaltung und [ICON_Army] Armeen durch die Ausrichtung Souveränität früher formen.')			WHERE Tag='LOC_TRAIT_LEADER_AMABUTHO_DESCRIPTION' 							AND Language ='de_DE';
...
--UPDATE LocalizedText SET Text = REPLACE(Text, 'May form [ICON_Corps] Corps after unlocking the Mercenaries civic and [ICON_Army] Armies after unlocking the Nationalism civic).',	'May form [ICON_Corps] Corps after unlocking the Civil Service civic and [ICON_Army] Armies after unlocking the Sovereignty civic.')		WHERE Tag='LOC_TRAIT_LEADER_AMABUTHO_DESCRIPTION' 							AND Language ='de_DE';
--------------------------------------------------------------