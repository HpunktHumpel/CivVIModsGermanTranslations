...
VALUES	(	'de_DE',	'LOC_JNR_RIB_BANANAS_RESOURCE_SET',								'[ICON_RESOURCE_BANANAS] Bananen'),
		...
		(	'de_DE',	'LOC_IMPROVEMENT_JNR_JUNGLE_PLANTATION_DESCRIPTION',			'Schaltet die Handwerkerfähigkeit frei, Mischplantagen in Städten mit mindestens 1 verbesserten {LOC_JNR_RIB_BANANAS_RESOURCE_SET} Ressource zu errichten.[NEWLINE][NEWLINE]+1 [ICON_Food] Nahrung.[NEWLINE]+1 [ICON_Production] Produktion wenn Feudalismus entdeckt wurde.[NEWLINE]+1 [ICON_Food] Nahrung durch die Wissenschaftstheorie.[NEWLINE]+2 [ICON_Gold] Gold, wenn Globalisierung entdeckt wurde.[NEWLINE]+0.5 [ICON_HOUSING] Wohnraum.[NEWLINE]Kann durch Naturkatastrophen nur geplündert (nicht zerstört) werden.[NEWLINE][NEWLINE]Kann nur in Dschungel gebaut werden.'),
		(	'de_DE',	'LOC_IMPROVEMENT_FISHERY_DESCRIPTION_JNR_UC',					'Schaltet die Handwerkerfähigkeit frei, Fischereien zu errichten.[NEWLINE][NEWLINE]+1 zusätzliche [ICON_Food] Nahrung für jede angrenzende Meeresressource.[NEWLINE]+2 [ICON_Gold] Gold für jede angrenzende Meeresressource, sobald Plastik erforscht ist.[NEWLINE]+0.5 [ICON_HOUSING] Wohnraum.[NEWLINE][NEWLINE]Muss auf Küste gebaut werden.'),
