...
values
    ...
    ('de_DE',	'LOC_BUILDING_NILOMETER_HD_NAME',			'Nilometer'),
    ...
    ('de_DE',	'LOC_BUILDING_TRIUMPHAL_ARCH_NAME',			'Triumphbogen'),
    ...
    ('de_DE',	'LOC_BUILDING_OFFICIAL_RUN_HANDCRAFT_NAME',		'Handwerkerbetrieb'),
    ...
    ('de_DE',	'LOC_BUILDING_BOOTCAMP_NAME',				'Trainingslager'),
    ...
    ('de_DE',	'LOC_BUILDING_FAIR_NAME',				'Jahrmarkt'),
    ...
    ('de_DE',	'LOC_BUILDING_TOTEMS_NAME',				'Totem'),
