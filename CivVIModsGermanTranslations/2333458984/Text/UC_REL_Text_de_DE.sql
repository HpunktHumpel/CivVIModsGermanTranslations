...
INSERT OR REPLACE INTO LocalizedText
		(Language,	Tag,												Text)
VALUES	('de_DE',	'LOC_BUILDING_JNR_ALTAR_NAME',						'Altar'),
		('de_DE',	'LOC_BUILDING_JNR_ALTAR_DESCRIPTION',				'+1 [ICON_Faith] Glauben für jede [ICON_GOVERNOR] Beförderung des in der Stadt etablierten Gouverneurs in der Stadt.[NEWLINE]Ermöglicht den Kauf von Missionaren. Missionare können nur mit [ICON_Faith] Glauben gekauft werden.'),
		...
		('de_DE',	'LOC_BUILDING_JNR_MONASTERY_NAME',					'Kloster'),
		...
		('de_DE',	'LOC_BUILDING_JNR_HOSPITIUM_NAME',					'Herberge'),
		...
		('de_DE',	'LOC_BUILDING_JNR_GARDEN_NAME',						'Garten'),
		...
		('de_DE',	'LOC_IMPROVEMENT_MONASTERY_NAME_UC_JNR',			'Abtei'),
		...
		('de_DE',	'LOC_POLICY_REVELATION_DESCRIPTION_JNR_UC',			'+2 [ICON_GreatProphet] Großer-Prophet-Punkte pro Runde. +1 [ICON_GreatProphet] Großer-Prophet-Punkte pro Runde für jeden Tempel und Kloster.'),
