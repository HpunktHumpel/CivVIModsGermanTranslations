...
--====================================================================================================================
	...
	-----------------------------------------------------
		...
		(
			...
			"de_DE",
			"Feste Neigung im Bildschirmfoto-Modus verwenden. Sie können die Neigung mit Alt + Ziehen anpassen oder die Tasten Z und C verwenden.[NEWLINE][NEWLINE][COLOR_RED]Warnung: Bestimmte Winkel und Neigungen können das Spiel zum Absturz bringen. Seien Sie vorsichtig![ENDCOLOR]"
		),
		(
