...
--------------------------------------------------------------------------------------------------------------------------
		...
		'Für jeden weiteren Bezirk desselben Typs, der entlang desselben Flusses gebaut wird, erhalten Stadtzentren +1 [ICON_AMENITIES] Annehmlichkeit und Bezirke liefern +1 des entsprechenden Ertrags. Felder sind immun gegen Überschwemmungsschäden. Bezirke, die an einem Fluss liegen, liefern eine Masse des entsprechenden Ertrags, wenn der Fluss überschwemmt wird.'),

		('de_DE',	'LOC_TRAIT_CIVILIZATION_SUK_SEASON_OF_INUNDATION_MESSAGE',
		'{3_Color}+{1_num} {2_FontIcon}[ENDCOLOR]'),
		
		('de_DE',	'LOC_TRAIT_CIVILIZATION_SUK_SEASON_OF_INUNDATION_FAITH',
		'+{1_num} [ICON_Faith] Glauben von Bezirken entlang des gleichen Flusses.'),
		('de_DE',	'LOC_TRAIT_CIVILIZATION_SUK_SEASON_OF_INUNDATION_SCIENCE',
		'+{1_num} [ICON_Science] Wissenschaft von Bezirken entlang des gleichen Flusses.'),
		('de_DE',	'LOC_TRAIT_CIVILIZATION_SUK_SEASON_OF_INUNDATION_GOLD',
		'+{1_num} [ICON_Gold] Gold von Bezirken entlang des gleichen Flusses.'),
		('de_DE',	'LOC_TRAIT_CIVILIZATION_SUK_SEASON_OF_INUNDATION_CULTURE',
		'+{1_num} [ICON_Culture] Kultur von Bezirken entlang des gleichen Flusses.'),
		('de_DE',	'LOC_TRAIT_CIVILIZATION_SUK_SEASON_OF_INUNDATION_PRODUCTION',
		'+{1_num} [ICON_PRODUCTION] Produktion von Bezirken entlang des gleichen Flusses.'),
--------------------------------------------------------------------------------------------------------------------------
-- Set-Ma’at
--------------------------------------------------------------------------------------------------------------------------
