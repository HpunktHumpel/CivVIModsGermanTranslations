--==========================================================================================================================
-- GREAT PERSON TEXT --geprüft am 31.05.2023
--==========================================================================================================================
...
--------------------------------------------------------------------
		...
		"+1 [Icon_Charges] Ladungen für Investoren.[NEWLINE]Erhalten einen freien Investor im Bezirk dieser Stadt."),
...
--------------------------------------------------------------------
		...
		"John Maynard Keynes wurde am 5. Juni 1883 in Cambridge als Sohn einer wohlhabenden Akademikerfamilie geboren. Sein Vater war Wirtschaftswissenschaftler und Philosoph, seine Mutter wurde die erste Bürgermeisterin der Stadt. Er war ein hervorragender Schüler in Eton und an der Universität Cambridge, wo er Mathematik studierte. Er schloss auch Freundschaft mit Mitgliedern der Bloomsbury-Gruppe von Intellektuellen und Künstlern."),

		("de_DE", 
		"LOC_PEDIA_GREATPEOPLE_PAGE_GREAT_PERSON_INDIVIDUAL_LEU_JOHN_KEYNES_CHAPTER_HISTORY_PARA_2",					
		"Nach seinem Abschluss arbeitete Keynes im India Office und arbeitete gleichzeitig - oft während der Bürozeiten - an einer Dissertation, die ihm ein Stipendium am King''s College einbrachte. 1908 schied er aus dem Staatsdienst aus und kehrte nach Cambridge zurück. Nach Ausbruch des Ersten Weltkriegs trat Keynes in das Finanzministerium ein und veröffentlichte nach dem Friedensvertrag von Versailles ''The Economic Consequences of the Peace'' (Die wirtschaftlichen Folgen des Friedens), in dem er die exorbitanten Kriegsreparationen kritisierte, die vom besiegten Deutschland gefordert wurden, und prophetisch vorhersagte, dass dies die Rachegelüste der Deutschen fördern würde. Dieses Bestseller-Buch machte ihn weltberühmt."),

		("de_DE", 
		"LOC_PEDIA_GREATPEOPLE_PAGE_GREAT_PERSON_INDIVIDUAL_LEU_JOHN_KEYNES_CHAPTER_HISTORY_PARA_3",					
		"In der Zwischenkriegszeit erwarb Keynes ein beträchtliches persönliches Vermögen auf den Finanzmärkten und verbesserte als Verwalter des King''s College dessen finanzielle Lage erheblich. Er wurde ein prominenter Kunstmäzen und Vorstandsmitglied einer Reihe von Unternehmen. Im Jahr 1926 heiratete er Lydia Lopokova, eine russische Ballerina."),

		("de_DE", 
		"LOC_PEDIA_GREATPEOPLE_PAGE_GREAT_PERSON_INDIVIDUAL_LEU_JOHN_KEYNES_CHAPTER_HISTORY_PARA_4",					
		"Keynes'' bekanntestes Werk, ''The General Theory of Employment, Interest and Money'' (Allgemeine Theorie der Beschäftigung, des Zinses und des Geldes), wurde 1936 veröffentlicht und wurde zu einem Maßstab für künftiges wirtschaftliches Denken. Es sicherte ihm auch seine Position als einflussreichster Wirtschaftswissenschaftler Großbritanniens, und mit dem Beginn des Zweiten Weltkriegs arbeitete er wieder für das Finanzministerium. Im Jahr 1942 wurde er zum Mitglied des Oberhauses ernannt."),

		("de_DE", 
		"LOC_PEDIA_GREATPEOPLE_PAGE_GREAT_PERSON_INDIVIDUAL_LEU_JOHN_KEYNES_CHAPTER_HISTORY_PARA_5",					
		"In den Kriegsjahren spielte Keynes eine entscheidende Rolle bei den Verhandlungen, die die internationale Wirtschaftsordnung der Nachkriegszeit prägen sollten. Im Jahr 1944 leitete er die britische Delegation bei der Konferenz von Bretton Woods in den Vereinigten Staaten. Auf dieser Konferenz war er maßgeblich an der Planung der Weltbank und des Internationalen Währungsfonds beteiligt. Er starb am 21. April 1946.");
