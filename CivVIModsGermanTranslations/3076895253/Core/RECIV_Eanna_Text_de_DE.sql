...
INSERT OR IGNORE INTO LocalizedText
		(Language,		Tag,												Text)
VALUES	('de_DE',		'LOC_DISTRICT_JNR_EANNA_DESCRIPTION',				'Einzigartiger Bezirk Sumers für religöse Aktivitäten. Ersetzt die Heilige Stätte und ist günstiger im Bau.[NEWLINE][NEWLINE]Jeder Zikkurat im Stadtgebiet erhält +1 [ICON_Gold] Gold für jedes Gebäude im Bezirk.[NEWLINE][NEWLINE]+2 [ICON_Faith] Glauben für angrenzendes Stadtzentrum, Fluss und Oase. +1 [ICON_Faith] Glauben für angrenzende Zikkurat. Keinen Glauben durch Berge und Wälder.'),
		...
		('de_DE',		'LOC_IMPROVEMENT_ZIGGURAT_DESCRIPTION_NO_ADJACENT',	'[NEWLINE]Kann nicht angrenzend an weitere Zikkurat gebaut werden.');

UPDATE LocalizedText SET Text=REPLACE(Text,'[NEWLINE]Cannot be built adjacent to other Ziggurats.', '[NEWLINE]Kann nicht angrenzend an weiteren Zikkurat gebaut werden') WHERE Language = 'de_DE' AND Tag='LOC_IMPROVEMENT_ZIGGURAT_DESCRIPTION';
--------------------------------------------------------------
