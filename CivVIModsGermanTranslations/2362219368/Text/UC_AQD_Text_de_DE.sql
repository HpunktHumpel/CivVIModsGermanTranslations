...
VALUES	('LOC_DISTRICT_AQUEDUCT_NAME_JNR_UC',					'de_DE',	'Zisterne'),
		('LOC_DISTRICT_AQUEDUCT_DESCRIPTION_JNR_UC',			'de_DE',	'Ein Bezirk, der diese Stadt mit Süßwasser von einem angrenzenden Fluss, See, Berg oder Oase versorgt. Städte ohne bestehende Süßwasserquelle erhalten +6 [ICON_Housing] Wohnraum. Städte die bereits frisches Wasser haben, erhalten +2 [ICON_Housing] Wohnraum.[NEWLINE]+1 [ICON_Amenities] Annehmlichkeit, wenn neben einem geothermalen Riss gebaut.[NEWLINE]Verhindert [ICON_Food] Nahrungsverlust während einer Dürre.[NEWLINE]Muss angrenzend an das Stadtzentrum gebaut werden.[NEWLINE]Militärpioniere können den Bau mit einer Ladung um 20% voranbringen.'),
		('LOC_DISTRICT_BATH_NAME_JNR_UC',						'de_DE',	'Aquädukt'),
		('LOC_DISTRICT_BATH_DESCRIPTION_JNR_UC',				'de_DE',	'Ein einzigartiger Bezirk der Römer. Ersetzt die Zisterne.[NEWLINE]Versorgt diese Stadt mit Süßwasser von einem angrenzenden Fluss, See, Berg oder Oase. Städte ohne bestehende Süßwasserquelle erhalten +6 [ICON_Housing] Wohnraum. Städte die bereits frisches Wasser haben, erhalten +2 [ICON_Housing] Wohnraum. Zusätzlich +2 [ICON_Housing] Wohnraum und +1 [ICON_Amenities] Annehmlichkeiten.[NEWLINE]+1 [ICON_Amenities] weitere Annehmlichkeit, wenn neben einem geothermalen Riss gebaut.[NEWLINE]Verhindert [ICON_Food] Nahrungsverlust während einer Dürre.[NEWLINE]Muss angrenzend an das Stadtzentrum gebaut werden.[NEWLINE]Militärpioniere können den Bau mit einer Ladung um 20% voranbringen.'),
		('LOC_BUILDING_JNR_ORCHARD_NAME',						'de_DE',	'Obstgarten'),
		('LOC_BUILDING_JNR_ORCHARD_DESCRIPTION',				'de_DE',	'+1 [ICON_Gold] Gold auf angrenzenden Farmen, Plantagen, Weiden, Lagern, Fischereien und einzigartigen Verbesserungen mit [ICON_Food] Nahrungsertragsbonus.[NEWLINE]Stellt der Stadt +1 [ICON_Power] Strom aus erneuerbarer Solarenergie zur Verfügung (wenn Zukunft erreicht).[NEWLINE][NEWLINE]+50% [ICON_Production] Produktion dieses Gebäudes wenn neben See oder Oase.'),
		('LOC_BUILDING_JNR_HAMMER_WORKS_NAME',					'de_DE',	'Hammerwerk'),
		('LOC_BUILDING_JNR_HAMMER_WORKS_DESCRIPTION',			'de_DE',	'Zisternen in dieser Stat erhalten +1 [ICON_Production] Produktion und weitere +1 [ICON_Production] Produktion für jeweils 2 angrenzende Bezirke.[NEWLINE]+2 [ICON_Strength] Kampfstärke für alle in dieser Stadt ausgebildeten Einheiten.[NEWLINE]Versorgt diese Stadt mit +1 [ICON_Power] Strom aus erneuerbarer Wasserkraft (wenn Moderne erreicht).[NEWLINE]Versorgt die Stadt mit weiterem +1 [ICON_Power] Strom aus erneuerbarer Wasserkraft, wenn die Zukunft erreicht ist.[NEWLINE][NEWLINE]+50% [ICON_Production] Produktion in diesem Bezirk wenn eine Mühle oder ein verbessertes [ICON_RESOURCE_IRON] Eisenvorkommen in der Stadt vorhanden sind.'),
		('LOC_BUILDING_JNR_BATHHOUSE_NAME',						'de_DE',	'Badehaus'),
		('LOC_BUILDING_JNR_BATHHOUSE_DESCRIPTION',				'de_DE',	'+1 [ICON_Faith] Glauben für je 5 Bewohner in der Stadt, limitiert bei +6.[NEWLINE]Gibt der Stadt +1 [ICON_Power] Strom aus geothermalen Energiequellen,  sobald die Zukunft erreicht wurde.[NEWLINE][NEWLINE]+50% [ICON_Production] Produktion, wenn auf einem atemberaubenden Feld gebaut, neben einem geothermalen Riss oder neben einem VUlkan.'),
		('LOC_BUILDING_SEWER_DESCRIPTION_JNR_UC',				'de_DE',	'+1 [ICON_Housing] Wohnraum und -1 [ICON_Gold] Gold für jeden angrenzenden Spezialbezirk.[NEWLINE]Liefert der Stadt +1 [ICON_Power] aus geothermalen Energiequellen, sobald die Zukunft erreicht wurde.'),
