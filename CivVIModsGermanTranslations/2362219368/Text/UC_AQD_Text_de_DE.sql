...
VALUES	('LOC_DISTRICT_AQUEDUCT_NAME_JNR_UC',					'de_DE',	'Zisterne|Zisterne|Zisterne|Zisterne|Zisterne', 													'feminine',	1			),	
		('LOC_DISTRICT_BATH_NAME_JNR_UC',						'de_DE',	'Aquädukt|Aquädukt|Aquädukt|Aquädukt|Aquädukt', 													'neuter',	1			),
		('LOC_BUILDING_JNR_ORCHARD_NAME',						'de_DE',	'Obstgarten|Obstgarten|Obstgarten|Obstgarten|Obstgarten', 											'masculine',1			),
		('LOC_BUILDING_JNR_HAMMER_WORKS_NAME',					'de_DE',	'Schmiede|Schmiede|Schmiede|Schmiede|Schmiede', 													'feminine',	1			),
		('LOC_BUILDING_JNR_BATHHOUSE_NAME',						'de_DE',	'Badehaus|Badehaus|Badehaus|Badehaus|Badehaus', 													'neuter',	1			),
		('LOC_ABILITY_JNR_HARDENED_STEEL_NAME',					'de_DE',	'Schmiedegehärtet|Schmiedegehärtet|Schmiedegehärtet|Schmiedegehärtet|Schmiedegehärtet', 			'neuter',	1			),
		('LOC_POLICY_JNR_RESERVOIRS_NAME',						'de_DE',	'Vorratsbehälter|Vorratsbehälter|Vorratsbehälter|Vorratsbehälter|Vorratsbehälter', 					'masculine',1			),
		('LOC_POLICY_JNR_GARDEN_CITIES_NAME',					'de_DE',	'Stadtgärten|Stadtgärten|Stadtgärten|Stadtgärten|Stadtgärten', 										'feminine',	2			),
...
VALUES	('LOC_DISTRICT_AQUEDUCT_DESCRIPTION_JNR_UC',			'de_DE',	'Ein Bezirk, der diese Stadt mit Süßwasser von einem angrenzenden Fluss, See, Berg oder Oase versorgt. Städte ohne bestehende Süßwasserquelle erhalten +6 [ICON_Housing] Wohnraum. Städte die bereits frisches Wasser haben, erhalten +2 [ICON_Housing] Wohnraum.[NEWLINE]+1 [ICON_Amenities] Annehmlichkeit, wenn neben einem geothermischen Riss gebaut.[NEWLINE]Verhindert [ICON_Food] Nahrungsverlust während einer Dürre.[NEWLINE]Muss angrenzend an das Stadtzentrum gebaut werden.[NEWLINE]Militärpioniere können den Bau mit einer Ladung um 20% voranbringen.'),
		...
		('LOC_BUILDING_JNR_ORCHARD_DESCRIPTION',				'de_DE',	'+1 [ICON_Gold] Gold auf angrenzenden Verbesserungen mit [ICON_Food] Nahrungsertragsbonus.[NEWLINE]Stellt der Stadt +1 [ICON_Power] Energie aus erneuerbarer Solarenergie zur Verfügung (wenn Zukunft erreicht).[NEWLINE][NEWLINE]+50% [ICON_Production] Produktionsbonus für dieses Gebäude beim Bau neben einem See oder einer Oase.'),
		...
		('LOC_BUILDING_JNR_HAMMER_WORKS_DESCRIPTION_UC_PRD',	'de_DE',	'Zisternen in dieser Stadt erhalten +1 [ICON_Production] Produktion und zusätzliche +1 [ICON_Production] Produktion für jeweils 2 angrenzende Bezirke.[NEWLINE]+2 [ICON_Strength] Kampfstärke für alle in dieser Stadt ausgebildeten Einheiten.[NEWLINE]Versorgt diese Stadt mit +1 [ICON_Power] Energie aus erneuerbarer Wasserkraft (wenn Moderne erreicht).[NEWLINE]Versorgt die Stadt mit zusätzlich +1 [ICON_Power] Energie aus erneuerbarer Wasserkraft, wenn die Zukunft erreicht ist.[NEWLINE][NEWLINE]+50% [ICON_Production] Produktionsbonus beim Bau des Hammerwerks, wenn die Stadt ein Bewässerungsrad besitzt oder ein verbessertes [ICON_RESOURCE_IRON] Eisenvorkommen in der Stadt vorhanden ist.'),
		...
		('LOC_ABILITY_JNR_HARDENED_STEEL_DESCRIPTION',			'de_DE',	'+2 [ICON_Strength] Kampfstärke.(Schmiedegehärtet)'),
		('LOC_POLICY_JNR_RESERVOIRS_DESCRIPTION',				'de_DE',	'+1 [ICON_Food] Nahrung für alle Verbesserungen mit einem [ICON_Food] Nahrungsertragsbonus angrenzend an eine Zisterne, Damm oder Kanal.'),
		('LOC_POLICY_JNR_GARDEN_CITIES_DESCRIPTION',			'de_DE',	'+1 [ICON_Food] Nahrung für alle Felder angrenzend an eine Zisterne, Damm, Kanal oder Wohnviertel.'),
		('LOC_POLICY_JNR_WATER_TREATMENT_DESCRIPTION',			'de_DE',	'+1 [ICON_Housing] Wohnraum für jedes Gebäude der Zisterne. Wird verdoppelt, bei atemberaubender Anziehungskraft des Bezirks.'),
