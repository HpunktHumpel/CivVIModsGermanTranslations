...
INSERT OR REPLACE INTO LocalizedText
		...
		('LOC_DISTRICT_AQUEDUCT_NAME_JNR_UC',		'de_DE', 'Zisterne|Zisterne|Zisterne|Zisterne|Zisterne', 'feminine', 1),
		('LOC_DISTRICT_BATH_NAME_JNR_UC',				'de_DE', 'Aquädukt|Aquädukt|Aquädukt|Aquäduktes|Aquädukt', 'neuter', 1),
