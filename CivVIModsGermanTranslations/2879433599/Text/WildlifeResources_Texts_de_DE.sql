...
SET Text = REPLACE(Text,"[NEWLINE][NEWLINE]Aquatic Animal Exhibits produced in this city increase [ICON_TOURISM] Tourism at the city by 100% while produced. +4 [ICON_Tourism] Tourism for every new Aquatic Exhibit completed at this city.",
						"[NEWLINE][NEWLINE]Während einer Wassertier-Ausstellung wird der [ICON_TOURISM] Tourismusausstoß der Stadt verdoppelt. +4 [ICON_Tourism] Tourismus durch jede vollendete neue Wassertier-Ausstellung der Stadt.")
