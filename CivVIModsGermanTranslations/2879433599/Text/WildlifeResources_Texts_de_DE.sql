...
VALUES
		...
		"Ressourcenbasierendes Projekt, das während der Durchführung +2 [ICON_AMENITIES] Annehmlichkeiten gewährt und 100% der [ICON_PRODUCTION] Produktion der Stadt zu [ICON_GOLD] Gold umwandelt.[NEWLINE]Wenn die Stadt einen Unterhaltungskomplex besitzt, verdoppeln sich während der Durchführung die [ICON_AMENITIES] Annehmlichkeiten und der Bezirk gewährt +4 [ICON_TOURISM] Tourismus.[NEWLINE][NEWLINE]Wenn die Stadt einen Zoo besitzt, gewährt die Stadt während der Durchführung +100% [ICON_TOURISM] Tourismus und nach Vollendung permanent +4 [ICON_Tourism] Tourismus.[NEWLINE][NEWLINE]Die Kosten variieren je nach Spielgeschwindigkeit.[NEWLINE]"),
		...
		"Benötigt einen Wasserpark.[NEWLINE]Ressourcenbezogenes Projekt, das während der Durchführung +4 [ICON_AMENITIES] Annehmlichkeiten und +8 [ICON_TOURISM] Tourismus gewährt. Wandelt [ICON_PRODUCTION] Produktion zu [ICON_GOLD] Gold um.[NEWLINE][NEWLINE]Wenn die Stadt ein Aquarium besitzt, gewährt die Stadt während der Durchführung +100% [ICON_TOURISM] Tourismus und nach Vollendung permanent +4 [ICON_Tourism] Tourismus.[NEWLINE][NEWLINE]Die Kosten variieren je nach Spielgeschwindigkeit.[NEWLINE]"),
		...
		"Unser Volk jubelt als [COLOR_GREEN][ICON_LEU_LOCAL_FAUNA] {1_UnitName}[ENDCOLOR] in unseren Landen geboren wurde!"),
...
SET Text = REPLACE(Text,"[NEWLINE][NEWLINE]Aquatic Animal Exhibits produced in this city increase [ICON_TOURISM] Tourism at the city by 100% while produced. +4 [ICON_Tourism] Tourism for every new Aquatic Exhibit completed at this city.","[NEWLINE][NEWLINE]Während einer Wassertier-Ausstellung wird der [ICON_TOURISM] Tourismusausstoß der Stadt verdoppelt. +4 [ICON_Tourism] Tourismus durch jede vollendete neue Wassertier-Ausstellung der Stadt.")
WHERE Language= "de_DE" AND Tag = "LOC_BUILDING_AQUARIUM_DESCRIPTION";

UPDATE LocalizedText
SET Text = REPLACE(Text,"[NEWLINE][NEWLINE]Animal Exhibits produced in this city increase [ICON_TOURISM] Tourism at the city by 100% while produced. +4 [ICON_Tourism] Tourism for every new Animal Exhibit completed at this city.","[NEWLINE][NEWLINE]Während einer Wildtier-Ausstellung wird der [ICON_TOURISM] Tourismusausstoß der Stadt verdoppelt. +4 [ICON_Tourism] Tourismus für jede volendete neue Wildtier-Ausstellung der Stadt."
WHERE Language= "de_DE" AND Tag = "LOC_BUILDING_ZOO_EXPANSION1_DESCRIPTION";

UPDATE LocalizedText
SET Text = "Planetenplanung|Planetenplanung|Planetenplanung|Planetenplanung|Planetenplanung", Gender = "feminine", Plurality = 1
