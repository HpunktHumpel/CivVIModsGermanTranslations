...
--		('LOC_BUILDING_JNR_ACADEMY_DESCRIPTION',					'de_DE',	'Description'),
		...
		('LOC_DISTRICT_JNR_UC_Floodpains_Tundra_Science',			'de_DE',	'+{1_num} [ICON_Science] Wissenschaft von jedem angrenzenden Tundra-Schwemmland.'),
		('LOC_DISTRICT_JNR_UC_Spaceport_Science',					'de_DE',	'+{1_num} [ICON_SCIENCE] Wissenschaft von jedem angrenzenden Raketenstartplatz.'),
		('LOC_DISTRICT_JNR_UC_Water_Park_Science',					'de_DE',	'+{1_num} [ICON_SCIENCE] Wissenschaft von jedem angrenzenden Wasserpark.'),
		('LOC_DISTRICT_JNR_UC_Water_Park_Carnival_Science',			'de_DE',	'+{1_num} [ICON_SCIENCE] Wissenschaft von jedem angrenzenden Copacabana-Bezirk.'),
		('LOC_DISTRICT_JNR_UC_Luxury_Science',						'de_DE',	'+{1_num} [ICON_SCIENCE] Wissenschaft von jeder angrenzenden Luxusressource.'),
		('LOC_TRAIT_CIVILIZATION_NOBEL_PRIZE_DESCRIPTION_JNR_UC',	'de_DE',	'Schweden erhält 50 [ICON_Favor] diplomatische Gunst, wenn eine Große Persönlichkeit rekrutiert wird (auf Standardgeschwindigkeit). Schweden erhält +1 [ICON_GreatEngineer] Großer-Ingenieur-Punkt von Level 2 Industriegebietgebäude und +1 [ICON_GreatScientist] Großer-Wissenschaftler-Punkte von Level 2 Campus-Gebäuden. Wenn Schweden mit im Spiel ist, beginnen im Industriezeitalter drei zusätzliche einzigartige Weltkongress-Wettkämpfe.'),
