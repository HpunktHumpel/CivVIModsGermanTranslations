...
('de_DE', 'LOC_PEDIA_UNITPROMOTIONS_PAGE_PROMOTION_NS_SUPER_CARRIER_CHAPTER_HISTORY_PARA_1',
	'In der Zeit des Kalten Krieges und in der Folgezeit wurden die Flugzeugträger noch größer und damit auch ihre Fähigkeiten.  Sie ähnelten einer Kleinstadt und konnten über lange Zeiträume auf See eingesetzt werden.');