...
(	'de_DE',	'LOC_POLICY_JNR_MEMES_NAME',					'Internetphänomen|Internetphänomen|Internetphänomen|Internetphänomens|Internetphänomen',								'neuter',	1			);
...
VALUES	('de_DE',	'LOC_BUILDING_JNR_ASSEMBLY_DESCRIPTION',					'+0,2 [ICON_CULTURE] Kultur pro Runde für jeden [ICON_Citizen] Bürger der Stadt. Gewährt +2 Loyalität pro Runde in der Stadt.'),
		...
		('de_DE',	'LOC_POLICY_JNR_MEMES_DESCRIPTION',							'Zusätzliche [ICON_CULTURE] Kultur durch Gebäude im Theaterplatz: in Höhe der Gebäudestufe , bei 15 [ICON_CITIZEN] Stadtbevölkerung und mehr, in Höhe der Gebäudestufe bei +4 Nachbarschaftsbonus und mehr. Museen sind davon unberührt.');
--------------------------------------------------------------