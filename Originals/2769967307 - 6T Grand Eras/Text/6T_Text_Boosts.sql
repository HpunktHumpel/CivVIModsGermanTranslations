...
VALUES			 ('LOC_BOOST_TRIGGER_6T_CITIZENSHIP',				'Build 2 Theater Square districts.'),
		...
		('LOC_BOOST_TRIGGER_LONGDESC_BALLISTICS_JNR_6T',			'Your quartermasters are improving powder storage and logistics for your heavy cannon emplacements, making it easier to take them into the field, too.'),
		...
		('LOC_BOOST_TRIGGER_LONGDESC_6T_SIEGE_ENGINES',				'Hurling rocks at walls is working out well so far. With more advanced engines we could launch 90kg projectiles at targets over 300m away.'),
				 ('LOC_BOOST_TRIGGER_SIEGE_TACTICS_JNR_UC',			'Own 2 Bombards.'),
		('LOC_BOOST_TRIGGER_LONGDESC_SIEGE_TACTICS_JNR_UC',			'After creating bombards you realize that castles are not impregnable – you need a stauncher defense!.'),
