...
--==========================================================================================================================		
		...
		"+200% [ICON_POWER] Power for all Offshore Windfarms, Solar Farms, Wind Farms, Geothermal Plants, and Hydroelectric Dams. This building and these improvements provide [ICON_TOURISM] Tourism equal to their [ICON_POWER] Power. +1 Appeal to tiles adjacent to Rainforest and Marsh in your empire. Must be built next to a River adjacent to a Garden district with a Conservatory."),

		("en_US",
		"LOC_BUILDING_EIFFEL_TOWER_DESCRIPTION",
		"All tiles in your civilization gain +2 Appeal. Must be built on flat land adjacent to a Garden District."),
