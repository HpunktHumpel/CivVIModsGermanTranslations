...
--==========================================================================================================================		
		...
		"The Landscape Garden takes advantage of Appeal in surrounding tiles. Increases the Appeal of adjacent tiles by 1.[NEWLINE][NEWLINE]Provides up to +3 [ICON_CULTURE] Culture based on the Appeal of its tile.[NEWLINE][NEWLINE]May be built on tiles with Woods, Rainforests, Marshes and Floodplains. When built in a tile with Breathtaking Appeal, the Landscape Garden also allows other Districts in the city to be built on the same Features."),
...
--==========================================================================================================================		
		...
		"Provides [ICON_Gold] Gold based on the Landscape Garden's base [ICON_CULTURE] Culture bonus.[NEWLINE][newline]+1 [ICON_Gold] Gold and [ICON_CULTURE] Culture to adjacent land  Charming Tiles.+2 [ICON_GOLD] Gold and [ICON_Culture] Culture to adjacent unimproved land Breathtaking Tiles.[NEWLINE]+1 [ICON_Gold] Gold and [ICON_Culture] Culture to adjacent coast tiles. +2 [ICON_Gold] Gold and [ICON_Culture] Culture to adjacent unimproved coast tiles with features."),
...
--==========================================================================================================================		
		...
		"+200% [ICON_POWER] Power for all Offshore Windfarms, Solar Farms, Wind Farms, Geothermal Plants, and Hydroelectric Dams. This building and these improvements provide [ICON_TOURISM] Tourism equal to their [ICON_POWER] Power. +1 Appeal to tiles adjacent to Rainforest and Marsh in your empire. Must be built adjacent to a Landscape Garden district with a Conservatory."),

		("en_US",
		"LOC_BUILDING_EIFFEL_TOWER_DESCRIPTION",
		"All tiles in your civilization gain +2 Appeal. Must be built on flat land adjacent to a Landscape Garden district."),
...
SET Text = "May not be built in a city with a Landscape Garden District. "||Text
...
VALUES		
		...
		"District-based project which increases Appeal at the city's tiles by 1 while produced. Earns [ICON_GREATENGINEER] Great Engineer and [ICON_GREATARTIST] Great Artist points upon completion.");
